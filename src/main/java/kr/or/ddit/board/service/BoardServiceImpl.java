...
public class BoardServiceImpl implements IBoardService {
	...
	@Override
	public List<BoardVO> selectByPage2(Map<String, Object> map) {
		// TODO Auto-generated method stub
	...
	@Override
	public PageVO pageInfo3(int page, String memId) {
		
		//전체 글 갯수 구하기
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("mem_id", memId);
		
		int count = this.totalCount2(map);
