...
public class ProductUpload extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/includes/admin/product/4-4.shopUpload.jsp").forward(request, response);
	}
...
//		String uploadPath = "C:\\Users\\PC-13\\Desktop\\중프\\productfiles";
		...
		System.out.println("상세정보테스트"+productInfo);
...
//				ProductVO pvo = new ProductVO();
		...
		request.setAttribute("status", "productSecc");
