      ...
      <section class="sign-in">
         <div class="container">
            <div class="signin-content">
               ...
               <h2 class="form-title"><a href="<%=request.getContextPath()%>/mainList.do" style="text-decoration: none; color: #bbc7de;">PangPang Mall.</a></h2>
                  <h2 class="form-title" style="font-size: 20px;">Log in</h2>
...
//-----------------------------------------------------------------------
   ...
   if(status == "blackMember"){
      swal("로그인 실패", "로그인 할 수 없는 계정입니다.","error");
