...
<body>
	...
	<!-- 레이아웃 --><%@include file="/includes/admin/key3.adminMain.jsp"%>




	<!-- 레이아웃 --><%@include file="/includes/admin/key4-1.adminLeftSideMenu.jsp"%>
	<div class="col-md-9">
		<!-- 레이아웃 --><%@include file="/includes/admin/key4-2.adminContents.jsp"%>
	</div>
	<!-- 레이아웃 --><%@include file="/includes/admin/key4-3.adminPagination.jsp"%>
