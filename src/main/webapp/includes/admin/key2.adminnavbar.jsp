	...
	<div class="sticky-nav js-sticky-header">
		...
		<div class="container position-relative">
			<div class="site-navigation text-center dark">
				<a
					href="<%=request.getContextPath()%>/includes/admin/adminstart.jsp"
					class="logo menu-absolute m-0">PangPang Mall<span
					class="text-primary">.</span></a>
				<ul class="js-clone-nav pl-0 d-none d-lg-inline-block site-menu">
					<li><a
						href="<%=request.getContextPath()%>/memberList.do">Home</a></li>
					<!-- 상품관리, 카테고리 링크 -->
					<li><a href="<%=request.getContextPath()%>/productUpload.do">Product</a></li>
					<li><a
						href="<%=request.getContextPath()%>/includes/admin/board/key0.adminnoticIndex.jsp">Board</a></li>
					<li><a href="<%=request.getContextPath()%>/memberList.do">Member</a></li>
				</ul>

				<%
				MemberVO memV = (MemberVO) session.getAttribute("loginMember");
				%>
				...
				<div class="menu-icons">
					...
					<a style="margin-right: 20px; position: relative; top: 1px;"><%=memV.getMem_name()%>님</a>
