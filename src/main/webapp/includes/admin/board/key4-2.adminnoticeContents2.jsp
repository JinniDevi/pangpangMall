...
<div class="untree_co-section p-0">
	<div class="container">
		<div class="navbar navbar-expand-sm navbar-dark ml-4" >
			  <button type="button" class="btn btn-black col-2" style="margin-right:30%;" data-toggle="modal" data-target="#nModal" value="글쓰기"  id="write" data-whatever="@mdo">글쓰기</button>
