...
.custom-pagination ul li a, .custom-pagination ul li span {     line-height: 25px; }
.list-unstyled { display:flex;     flex-direction: row; }
.custom-pagination ul li { display:flex !important; margin:0 2px; }

.custom-pagination ul li a svg, .custom-pagination ul li span svg { top: 4px }
</style>
...
<div class="untree_co-section">
	<div class="container">
		...
		<%if(mem_id==null){ %>
			  <button type="button" class="btn btn-primary" style="visibility:hidden; margin-right:38%;" style="margin-left:5%;" data-toggle="modal" data-target="#wModal" value="글쓰기" style="margin-top:.6em" id="write" data-whatever="@mdo">글쓰기</button>
		<%}else{%>
...
<!--           </div> -->
          ...
          <div class="form-group">
            ...
            <textarea class="form-control txt" id="board_contents"  rows="20" name="board_contents"></textarea>
          </div>
