...
<style>
.plist .custom-pagination ul li a, .custom-pagination ul li span { justify-content: center;
    align-items: center; display: flex; }
    .plist .list-unstyled { display: flex !important; }
...
myPageboardListPage = function(vpage){
	
	   catval = $('#stype option:selected').val();;
