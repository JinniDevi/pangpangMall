...
<body>
	...
	<!-- 레이아웃 --><%@include file="/includes/board/key3.mypageboardMain.jsp"%>
	...
	<div class="col-md-9">
		<!-- 레이아웃 --><%@include file="/includes/board/key4-2.mypageboardContents.jsp"%>
	</div>
	<!-- 레이아웃 --><%@include file="/includes/board/key4-3.mypageboardPagination.jsp"%>
