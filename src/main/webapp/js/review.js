...
myReviewModifyServer = function() {
   $.ajax({
      url: 'http://localhost/modifyMyReview.do',
      data: formdata,
      type: 'post',
      success: function(res) {
         ...
         if (res.flag == "성공") {
            ...
            location.replace('/review/key0.myreviewIndex.jsp')
         }
      },
      error: function(xhr) {
         alert("상태 : " + xhr.status);
...
insertReviewWriteServer = function(rCont, rRate, pId, pNo) {
            ...
            $.each(res.datas, function(i, v) {
               ...
               code += `<div class="card">
                                   ...
                                   <div id="collapse${v.re_no}" class="collapse show" >
                                       ...
                                       <span class="rr" style="visibility:hidden;">${v.re_rate}</span>
                                 ...
                                 <p class="p2">
                                     <input type="button" idx="${v.re_no}" data-bs-toggle="modal" data-bs-target="#mrModal"  value="수정" name="modify" class="action">
