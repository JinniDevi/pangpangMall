...
<body>
	...
	<!-- 레이아웃 --><%@include file="/review/key3.myreviewMain.jsp"%>
	...
	<div class="col-md-9">
		<!-- 레이아웃 --><%@include file="/review/key4-2.myreviewContents.jsp"%>
	</div>
	<!-- 레이아웃 --><%@include file="/review/key4-3.myreviewPagination.jsp"%>
