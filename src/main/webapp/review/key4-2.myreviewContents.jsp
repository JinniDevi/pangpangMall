     ...
     <div class="modal-dialog">
       <div class="modal-content">
         ...
         <form id="mrform" name="mrform">         
            ...
            <label>리뷰 내용</label>
            <textarea style="width: 100%;" class="txt"  rows="10" cols="60" id= "re_content"  name="re_content"></textarea><br>
            
            <input type="button" value="전송" id="mrsend">
...
//          vc = vparents.find('.p3').html().trim(); // 내용
         ...
         // 모달창에 띄우기
         $('#mrform #re_no').val(vidx);
         
         $('#mrform input[name="re_rate"]').each(function(){
            if(vr==$(this).val()){
   ...
   $('#mrsend').on('click', function(){
	   
      // 입력한 모든 값을 가져온다. 
      formdata = $('#mrform').serialize();
